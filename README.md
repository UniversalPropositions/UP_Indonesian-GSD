...
- `git clone https://github.com/UniversalPropositions/UP_Indonesian-GSD.git`
...
- `python3 up2/merge_ud_up.py --input_ud=<ud_path_to_UD_Indonesian-GSD>/ --input_up=<up_path_to_UP_Indonesian-GSD>/ --output=<path_to_UD+UP_Indonesian-GSD>/`
